	...
	<div class="container">
		<div class="row">
			<div class="section-col col-xl-6 col-lg-8 col-md-10 offset-xl-3 offset-lg-2 offset-md-1">
				<img class="logo" src="assets/imgs/ismart-logo.png" />
				<div class="search">
					<form action="api/?action=search" method="POST" id="search_form">
						<h1 class="textmuted fw-bold h1 text-center title">
							TRA CỨU HỌC BỔNG<br/>
							MATH & SCIENCE ARENA
						</h1>
						<div class="row g-3 mb-4">
							...
							<div class="col-md-6">
								<input type="tel" pattern="^(0|\+84|84)\d{9}$" class="form-control" placeholder="Số điện thoại" aria-label="Số điện thoại" name="phone" required="required">
							</div>
						</div>
						<div class="row">
							<div class="col-12">
